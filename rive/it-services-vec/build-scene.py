...
VEC_BG=os.environ.get("VEC_BG","1")=="1"   # VEC_BG=0: raster plate under vector movers (hybrid)
...
def image(name,aid,x,y,ox=0,oy=0):
    ...
    i=nid()
    if VEC and not (name=="bg_plate" and not VEC_BG):
...
def asset(name):
    if VEC and not (name=="bg_plate" and not VEC_BG): return None
